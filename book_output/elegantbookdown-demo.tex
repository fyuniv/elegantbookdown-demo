...
\DefineVerbatimEnvironment{spverbatim}{Verbatim}{commandchars=\\\{\}}
...
\href{http://passyworldofmathematics.com/exponents-in-the-real-world/}{Exponential functions}
...
By \ref{cor:corB}, we know that \ldots. \ref{thm:pyThm}
