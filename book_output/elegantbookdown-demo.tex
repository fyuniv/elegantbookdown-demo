...
\protect\hypertarget{thm:pythagThm}{}{\label{thm:pythagThm} \iffalse (Pythagorean Theorem) \fi{} }
...
\begin{theorem}{Pythagorean Theorem}{pythagThm}
...
By \ref{pythagThm}, the hypothenuose is
\[
\sqrt{3^2+4^2}=5.
\]
